...
class WhereRowValuesTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        DB::table('compatibility_row_values')->insert([
            ['id' => 1, 'category' => 'featured', 'category_id' => 1, 'score' => 10],
            ['id' => 2, 'category' => 'featured', 'category_id' => 1, 'score' => 20],
            ['id' => 3, 'category' => 'standard', 'category_id' => 2, 'score' => 10],
            ['id' => 4, 'category' => 'standard', 'category_id' => 2, 'score' => 20],
            ['id' => 5, 'category' => 'archived', 'category_id' => 3, 'score' => 10],
        ]);
    }
