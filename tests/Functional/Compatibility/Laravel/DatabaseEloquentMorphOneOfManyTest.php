...
class DatabaseEloquentMorphOneOfManyTest extends LaravelTestCase
{
    /**
...
//    }
    ...
    public function test_receiving_model()
    {
        $product = MorphOneOfManyTestProduct::create();
    ...
    public function test_morph_type()
    {
        $product = MorphOneOfManyTestProduct::create();
        $product->states()->create([
            'state' => 'draft',
    ...
    public function test_force_create_morph_type()
    {
        $product = MorphOneOfManyTestProduct::create();
    ...
    public function test_with_where_has()
    {
        $product = MorphOneOfManyTestProduct::create();
        $previousState = $product->states()->create([
            'state' => 'draft',
    ...
    public function test_with_where_relation()
    {
        $product = MorphOneOfManyTestProduct::create();
        $currentState = $product->states()->create([
            'state' => 'active',
