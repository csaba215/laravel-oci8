...
class EloquentModelCustomCastingTest extends LaravelTestCase
{
    ...
    public function test_model_with_custom_casts_unguarded_can_be_mass_assigned()
    {
    ...
    public function test_model_with_custom_casts_can_be_guarded_against_mass_assigned()
    {
        Person::preventSilentlyDiscardingAttributes();
