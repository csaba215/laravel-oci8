...
class DatabaseEloquentHasManyThroughIntegrationTest extends LaravelTestCase
{
    /**
    ...
    public function test_it_loads_a_has_many_through_relation_with_custom_keys()
    {
        $this->seedData();
    ...
    public function test_find_many_method()
    {
        HasManyThroughTestCountry::create(['id' => 1, 'name' => 'United States of America', 'shortname' => 'us'])
            ->users()->create(['id' => 1, 'email' => 'taylorotwell@gmail.com', 'country_short' => 'us'])
            ->posts()->createMany([
    ...
    public function test_first_or_fail_throws_an_exception()
    {
        ...
        $this->expectExceptionMessage('No query results for model [Yajra\Oci8\Tests\Functional\Compatibility\Laravel\HasManyThroughTestPost].');
    ...
    {
        $this->expectException(ModelNotFoundException::class);
        $this->expectExceptionMessage('No query results for model [Yajra\Oci8\Tests\Functional\Compatibility\Laravel\HasManyThroughTestPost] 1');
    ...
    public function test_find_or_fail_with_many_throws_an_exception()
    {
        $this->expectException(ModelNotFoundException::class);
        $this->expectExceptionMessage('No query results for model [Yajra\Oci8\Tests\Functional\Compatibility\Laravel\HasManyThroughTestPost] 1, 2');
    ...
    public function test_find_or_fail_with_many_using_collection_throws_an_exception()
    {
        $this->expectException(ModelNotFoundException::class);
        $this->expectExceptionMessage('No query results for model [Yajra\Oci8\Tests\Functional\Compatibility\Laravel\HasManyThroughTestPost] 1, 2');
    ...
    public function test_find_or_method()
    {
        HasManyThroughTestCountry::create(['id' => 1, 'name' => 'United States of America', 'shortname' => 'us'])
            ->users()->create(['id' => 1, 'email' => 'taylorotwell@gmail.com', 'country_short' => 'us'])
            ->posts()->create(['id' => 1, 'title' => 'A title', 'body' => 'A body', 'email' => 'taylorotwell@gmail.com']);
    ...
    public function test_find_or_method_with_many()
    {
        HasManyThroughTestCountry::create(['id' => 1, 'name' => 'United States of America', 'shortname' => 'us'])
            ->users()->create(['id' => 1, 'email' => 'taylorotwell@gmail.com', 'country_short' => 'us'])
            ->posts()->createMany([
    ...
    public function test_find_or_method_with_many_using_collection()
    {
        HasManyThroughTestCountry::create(['id' => 1, 'name' => 'United States of America', 'shortname' => 'us'])
            ->users()->create(['id' => 1, 'email' => 'taylorotwell@gmail.com', 'country_short' => 'us'])
            ->posts()->createMany([
    ...
    public function test_each_by_id_returns_correct_models()
    {
        $this->seedData();
        $this->seedDataExtended();
        $country = HasManyThroughTestCountry::find(2);
    ...
    public function test_lazy_by_id()
    {
        $this->seedData();
        $this->seedDataExtended();
        $country = HasManyThroughTestCountry::find(2);
