...
class DatabaseEloquentIrregularPluralTest extends LaravelTestCase
{
    ...
    protected function tearDown(): void
    {
        ...
        $this->schema()->drop('irregular_plural_mottoes');
        $this->schema()->drop('cool_mottoes');
    ...
    public function test_it_pluralizes_the_table_name()
    {
    ...
    public function test_it_touches_the_parent_with_an_irregular_plural()
    {
    ...
    public function test_it_pluralizes_morph_to_many_relationships()
    {
