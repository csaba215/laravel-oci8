...
class DatabaseEloquentHasOneOfManyTest extends LaravelTestCase
{
    /**
    ...
    public function test_it_guesses_relation_name()
    {
        $user = HasOneOfManyTestUser::make();
        $this->assertSame('latest_login', $user->latest_login()->getRelationName());
    }

    public function test_it_guesses_relation_name_and_adds_of_many_when_table_name_is_relation_name()
    {
        $model = HasOneOfManyTestModel::make();
        $this->assertSame('logins_of_many', $model->logins()->getRelationName());
    }

    public function test_relation_name_can_be_set()
    {
    ...
    //    public function test_eager_loading_applies_constraints_to_inner_join_sub_query()
    //    {
    //        $user = HasOneOfManyTestUser::create();
    //        $relation = $user->latest_login();
    ...
    //    public function test_global_scope_is_not_applied_when_relation_is_defined_without_global_scope()
    //    {
    ...
    //    public function test_global_scope_is_not_applied_when_relation_is_defined_without_global_scope_with_complex_query()
    //    {
    ...
    public function test_qualifying_sub_select_column()
    {
        $user = HasOneOfManyTestUser::create();
        $this->assertSame('latest_login.id', $user->latest_login()->qualifySubSelectColumn('id'));
    }

    public function test_it_fails_when_using_invalid_aggregate()
    {
    ...
    public function test_it_gets_correct_results()
    {
        $user = HasOneOfManyTestUser::create();
    ...
    public function test_result_does_not_have_aggregate_column()
    {
        $user = HasOneOfManyTestUser::create();
        $user->logins()->create();
    ...
    public function test_it_gets_correct_results_using_shortcut_method()
    {
        $user = HasOneOfManyTestUser::create();
        $previousLogin = $user->logins()->create();
        $latestLogin = $user->logins()->create();
    ...
    public function test_it_gets_correct_results_using_shortcut_receiving_multiple_columns_method()
    {
        $user = HasOneOfManyTestUser::create();
        $user->prices()->create([
    ...
    public function test_key_is_added_to_aggregates_when_missing()
    {
        $user = HasOneOfManyTestUser::create();
        $user->prices()->create([
            'published_at' => '2021-05-01 00:00:00',
    ...
    public function test_it_gets_with_constraints_correct_results()
    {
        $user = HasOneOfManyTestUser::create();
        $previousLogin = $user->logins()->create();
        $user->logins()->create();
    ...
    public function test_it_eager_loads_correct_models()
    {
        $user = HasOneOfManyTestUser::create();
        $user->logins()->create();
        $latestLogin = $user->logins()->create();
    ...
    public function test_it_joins_other_table_in_sub_query()
    {
        $user = HasOneOfManyTestUser::create();
        $user->logins()->create();
    ...
    public function test_has_nested()
    {
        $user = HasOneOfManyTestUser::create();
        $previousLogin = $user->logins()->create();
        $latestLogin = $user->logins()->create();
    ...
    public function test_with_has_nested()
    {
        $user = HasOneOfManyTestUser::create();
        $previousLogin = $user->logins()->create();
        $latestLogin = $user->logins()->create();
    ...
    public function test_has_count()
    {
        $user = HasOneOfManyTestUser::create();
        $user->logins()->create();
        $user->logins()->create();
    ...
    public function test_is_not_method()
    {
        $user = HasOneOfManyTestUser::create();
        $login1 = $user->latest_login()->create();
        $login2 = $user->latest_login()->create();
    ...
    public function test_join_constraints()
    {
        $user = HasOneOfManyTestUser::create();
        $user->states()->create([
            'type' => 'foo',
    ...
    public function test_multiple_aggregates()
    {
        $user = HasOneOfManyTestUser::create();
    ...
    public function test_eager_loading_with_multiple_aggregates()
    {
    ...
    public function test_with_exists()
    {
        $user = HasOneOfManyTestUser::create();
    ...
    public function test_with_exists_with_constraints_in_join_sub_select()
    {
        $user = HasOneOfManyTestUser::create();
    ...
    public function test_with_soft_deletes()
    {
        $user = HasOneOfManyTestUser::create();
        $user->logins()->create();
    ...
    public function test_with_constraint_not_in_aggregate()
    {
        $user = HasOneOfManyTestUser::create();
    ...
    public function test_it_gets_correct_result_using_at_least_two_aggregates_distinct_from_id()
    {
        $user = HasOneOfManyTestUser::create();
