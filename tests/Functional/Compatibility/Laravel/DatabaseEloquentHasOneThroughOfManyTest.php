...
class DatabaseEloquentHasOneThroughOfManyTest extends LaravelTestCase
{
    ...
    public function test_it_guesses_relation_name(): void
    {
        $user = HasOneThroughOfManyTestUser::make();
        $this->assertSame('latest_login', $user->latest_login()->getRelationName());
    }

    public function test_it_guesses_relation_name_and_adds_of_many_when_table_name_is_relation_name(): void
    {
        $model = HasOneThroughOfManyTestModel::make();
        $this->assertSame('logins_of_many', $model->logins()->getRelationName());
    }

    public function test_relation_name_can_be_set(): void
    {
    ...
    public function test_it_fails_when_using_invalid_aggregate(): void
    {
    ...
    public function test_result_does_not_have_aggregate_column(): void
    {
    ...
    public function test_it_gets_correct_results_using_shortcut_method(): void
    {
        $user = HasOneThroughOfManyTestUser::factory()->hasIntermediates(2)->create();
        $previousLogin = $user->intermediates->last()->logins()->create();
        $latestLogin = $user->intermediates->first()->logins()->create();
    ...
    public function test_it_gets_correct_results_using_shortcut_receiving_multiple_columns_method(): void
    {
        $user = HasOneThroughOfManyTestUser::factory()->hasIntermediates(2)->create();
    ...
    public function test_key_is_added_to_aggregates_when_missing(): void
    {
        $user = HasOneThroughOfManyTestUser::factory()->hasIntermediates(2)->create();
        $user->intermediates->last()->prices()->create([
            'published_at' => '2021-05-01 00:00:00',
    ...
    public function test_it_gets_with_constraints_correct_results(): void
    {
        $user = HasOneThroughOfManyTestUser::factory()->hasIntermediates(2)->create();
        $previousLogin = $user->intermediates->last()->logins()->create();
        $user->intermediates->first()->logins()->create();
    ...
    public function test_it_eager_loads_correct_models(): void
    {
        $user = HasOneThroughOfManyTestUser::factory()->hasIntermediates(2)->create();
    ...
    public function test_it_joins_other_table_in_sub_query(): void
    {
        $user = HasOneThroughOfManyTestUser::factory()->hasIntermediates(2)->create();
        $user->intermediates->first()->logins()->create();
    ...
    public function test_is_not_method(): void
    {
        $user = HasOneThroughOfManyTestUser::factory()->hasIntermediates(2)->create();
        $login1 = $user->intermediates->last()->logins()->create();
        $login2 = $user->intermediates->first()->logins()->create();
    ...
    public function test_join_constraints(): void
    {
        $user = HasOneThroughOfManyTestUser::factory()->hasIntermediates(2)->create();
    ...
    public function test_multiple_aggregates(): void
    {
        $user = HasOneThroughOfManyTestUser::factory()->hasIntermediates(2)->create();
        $user->intermediates->last()->prices()->create([
            'published_at' => '2021-05-01 00:00:00',
    ...
    public function test_eager_loading_with_multiple_aggregates(): void
    {
    ...
    public function test_with_soft_deletes(): void
    {
        $user = HasOneThroughOfManyTestUser::factory()->hasIntermediates(1)->create();
        $user->intermediates->first()->logins()->create();
    ...
    public function test_with_constraint_not_in_aggregate(): void
    {
        $user = HasOneThroughOfManyTestUser::factory()->hasIntermediates(2)->create();
    ...
    public function test_it_gets_correct_result_using_at_least_two_aggregates_distinct_from_id(): void
    {
        $user = HasOneThroughOfManyTestUser::factory()->hasIntermediates(2)->create();
